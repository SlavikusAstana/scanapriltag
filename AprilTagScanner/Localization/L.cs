...
public static class L
{
    ...
    [
        ...
        ("CameraTimeout", "Таймаут подключения камеры (15 сек). Закройте другие программы с камерой.",
            "Camera connection timed out (15 sec). Close other apps using the camera."),
        ...
        ("GenCalibrationGroup", "Калибровка", "Calibration"),
        ("GenCalHeader", "Формат {0}, печать 100%", "Format {0}, print at 100%"),
        ("GenCalTagSize", "Размер тега: {0} × {1} мм", "Tag size: {0} × {1} mm"),
        ("GenCalCenterSpacing", "Центры соседних: {0} мм (↔), {1} мм (↕)",
            "Adjacent centers: {0} mm (↔), {1} mm (↕)"),
        ("GenCalMarginsSingle", "Поля: верх {0}, низ {1}, бока {2} мм",
            "Margins: top {0}, bottom {1}, sides {2} mm"),
        ("GenCalMarginsAll", "Поля: {0} мм", "Margins: {0} mm"),
        ("GenCalPrintNote", "Без «подогнать под страницу».", "Do not use “fit to page”."),

        ("GenScanFileLabel", "Файл скана:", "Scan file:"),
        ("GenScanFileBrowse", "Открыть", "Open"),
        ("GenScanFileClear", "Очистить", "Clear"),
        ("GenScanFileDialogTitle", "Открыть результат сканирования", "Open scan result"),
        ("GenScanFileDialogFilter",
            "Результаты скана (*.txt;*.csv;*.json)|*.txt;*.csv;*.json|Все файлы (*.*)|*.*",
            "Scan results (*.txt;*.csv;*.json)|*.txt;*.csv;*.json|All files (*.*)|*.*"),
        ("GenScanFileMissing", "Файл сканирования не найден.", "Scan file not found."),
        ("GenScanFileEmpty", "В файле нет тегов для исключения.", "The file contains no tags to exclude."),
        ("GenScanFileReadFailed", "Не удалось прочитать файл:\n{0}", "Could not read file:\n{0}"),
        ("GenScanFileLoaded", "Загружено {0} ID для {1} (уникальных: {2})",
            "Loaded {0} ID(s) for {1} (unique: {2})"),
        ("GenScanFileNoFamily", "Выберите файл сканирования.", "Select a scan file."),
        ("GenExcludeScan", "Исключить ID из файла", "Exclude IDs from file"),
        ("GenExcludeNotEnough",
            "Недостаточно свободных ID: нужно {0}, доступно {1} (максимум словаря {2}).",
            "Not enough free IDs: need {0}, only {1} available (dictionary max {2})."),
        ("GenSummaryExclude",
            "Будет создано {0} тег(ов), ID {1}…{2}, исключено из файла: {3}, страниц: {4}",
            "Will create {0} tag(s), ID {1}…{2}, excluded from file: {3}, pages: {4}"),
